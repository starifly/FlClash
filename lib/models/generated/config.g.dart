...
Config _$ConfigFromJson(Map<String, dynamic> json) => Config()
  ...
  ..fontSizeProps =
      FontSizeProps.fromJson(json['fontSizeProps'] as Map<String, dynamic>?)
...
Map<String, dynamic> _$ConfigToJson(Config instance) => <String, dynamic>{
      ...
      'fontSizeProps': instance.fontSizeProps,
...
_$FontSizePropsImpl _$$FontSizePropsImplFromJson(Map<String, dynamic> json) =>
    _$FontSizePropsImpl(
      custom: json['custom'] as bool? ?? false,
      scale: (json['scale'] as num?)?.toDouble() ?? defaultCustomFontSizeScale,
    );

Map<String, dynamic> _$$FontSizePropsImplToJson(_$FontSizePropsImpl instance) =>
    <String, dynamic>{
